...
public class SalarieAideADomicileService {
	 @Autowired
		...
		public long calculeLimiteEntrepriseCongesPermis(LocalDate moisEnCours, double congesPayesAcquisAnneeNMoins1,
			   ...
			   Double limiteConges = PonderaionDesCongésAcquisenNmoins11(congesPayesAcquisAnneeNMoins1, premierJourDeConge, dernierJourDeConge);
			...
			public double PonderaionDesCongésAcquisenNmoins11(double congesPayesAcquisAnneeNMoins1, LocalDate premierJourDeConge, LocalDate dernierJourDeConge){
