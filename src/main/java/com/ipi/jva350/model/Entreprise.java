...
=======
>>>>>>> 8be06f41773b0eea63ba333708015dcbdd26e594
...
<<<<<<< HEAD
    ...
    public static boolean estDansPlage(LocalDate d, LocalDate debut, LocalDate fin) throws Exception {
...
=======
	...
	// proportion selon l'avancement dans l'année, pondérée avec plus de pods plus
	// gros sur juillet et Aout (20 vs 8) :
	// "ça veut dire chaque mois compte plus que le précédent, dans une année de
	// travail donc décalé de 6 mois"
	...
	public static LocalDate getPremierJourAnneeDeConges(LocalDate d) {
		return d == null ? null
				: d.getMonthValue() > 5 ? LocalDate.of(d.getMonthValue(), 6, 1) : LocalDate.of(d.getYear() - 1, 6, 1);
	}
	...
	/*
	 * public static boolean estJourFerie(LocalDate jour) { return
	 * Entreprise.joursFeries(jour).stream().filter(d -> d.equals(jour)).count() >
	 * 0;
	 */
	/**
	 * *verifier que d se trouve entre la date debut et date fin
	 * 
	 * @param d
	 * @param debut
	 * @param fin
