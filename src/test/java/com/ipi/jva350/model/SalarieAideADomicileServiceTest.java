...
class SalarieAideADomicileServiceTest {
	   @Autowired
		...
		//Karima
		@Test
		public final void estHorsPlageNull() throws EntrepriseException {
		...
		//Lea
		@Test
		public final void estHorsPlageAvant() throws EntrepriseException {
		...
		//Lea
		@Test
		public final void estHorsPlageApres() throws EntrepriseException {
